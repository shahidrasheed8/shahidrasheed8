...
<details> 
  ...
  ## Shahid Rasheed — Backend Developer (Laravel)

  **Location:** Lahore, Punjab, Pakistan  •  **Phone:** +92 306 287 2169  •  **Email:** `shahidrasheedsmm@gmail.com`

  - **Portfolio:** `https://shahidrasheed.me`
  - **GitHub:** `https://github.com/shahidrasheed8`
  - **LinkedIn:** `https://www.linkedin.com/in/shahidrasheed8/`
  - **Twitter:** `https://twitter.com/shahidxbhatti`

  **Professional Summary**

  - **Highly skilled Laravel backend developer** experienced building enterprise-level web applications (HRMS, CRM, Task Management, Real Estate platforms). Expertise in Laravel (8, 10, 11), PHP 8.1/8.2, Livewire 3, MySQL and designing scalable APIs and real-time systems.

  **Core Technologies**

  - **Backend:** Laravel (8/10/11), PHP 8.1+, RESTful APIs, Eloquent ORM
  - **Frontend / Reactive UI:** Livewire 3, Blade templating, Bootstrap 4/5, Vite
  - **Databases & Storage:** MySQL / MariaDB, database design & query optimization
  - **Real-time & Messaging:** Pusher, Laravel Echo, WebSockets
  - **Auth & Security:** OAuth (Laravel Passport), multi-guard auth, role-based access control (Spatie / Laratrust)
  - **Integrations & Tools:** Paystack, Flutterwave, Google APIs (Calendar, OAuth, Cloud Vision), IMAP/Gmail sync, MPDF / PHPSpreadsheet
  - **Practices:** Git, migrations & seeding, unit & feature testing, performance optimization

  **Featured Projects**

  - **Ashley Fox** — Real Estate property listing platform (Laravel, PHP, MySQL, Bootstrap). (In development)
  - **Task Management System (TMS)** — Enterprise HR & task platform with Livewire 3, Laravel 10, MySQL, real-time chat, biometric attendance integration and salary management. Live: `https://tms.adamsonstrading.co.uk`
  - **Recruit CRM** — Recruitment management system with OCR CV parsing (Google Cloud Vision), multi-tenant pipelines, Spatie permissions. Live: `https://recruitmentcrm.co.uk/`
  - **NahjUpdated (HRMS)** — Laravel 11 HRMS with OAuth, Pusher, HelloSign and robust analytics. Live: `https://nahjerp.com`
  - **Staggar** — Celebrity-fan interaction platform with payment integrations (Paystack, Flutterwave), real-time messaging and video features. Live: `https://staggar.com`
  - **PropCo CRM** — Real estate CRM with Livewire, Vite, Laratrust; features include IMAP/email sync and Excel import/export. Live: `https://propcocrm.com`

  **Professional Experience (summary)**

  - **Backend Developer — Adamson's Trading** (Aug 2025 – Present)
    - Led development of enterprise task & HR platform (Laravel 10, Livewire 3). Implemented real-time features, biometric integration, and salary workflows.
  - **Laravel Developer — Reownlogics** (Mar 2024 – Aug 2025)
    - Built scalable backends and payment/real-time features across multiple enterprise apps.
  - **Junior Web Developer — Finjineers** (Jan 2023 – Mar 2024)
    - Implemented web interfaces and backend systems using PHP/Laravel.

  **Education**

  - Associate's Degree in Computer Science — University of the Punjab, Lahore (Oct 2018 – Apr 2020)

  **Notes**

  - This README was updated from `resume.html` (see `c:\xampp\htdocs\personal_portfolio\resume.html`).
  - Last updated: December 9, 2025

  ---

  If you'd like, I can:
  - Add badges (GitHub, tech stack) and a compact skills section
  - Generate a simple profile card HTML and include it in this repo

  Tell me which option you prefer or any wording edits you want.
  <tr>
